...
class VisualTrapezoidal : public VisualObject
{
public:
    explicit VisualTrapezoidal(glm::vec3 _position = glm::vec3(0.0f), glm::vec3 _rotation = glm::vec3(0.0f), glm::vec3 _scale = glm::vec3(1.0f), glm::vec3 _transformOffset = glm::vec3(0.0f), Shader::Material _material = Shader::Material());
